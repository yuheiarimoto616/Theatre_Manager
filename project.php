<!--Test Oracle file for UBC CPSC304 2018 Winter Term 1
  ...
  <html>
    ...
    <body>
        ...
        <form method="GET" action = "project.php">
            <input type = "hidden" id = "theatreDelete" name = "displayTheatreDeleteRequest">
            Theatre address:
            <select id = "theatres" name = "theatres">
                <?php
                if (connectToDB()) {   //connect to database first!
                    global $db_conn;
            ...
            <p><input type="submit" value = "Submit" name="displayTheatreDelete"></p>
        </form>
        <?php
        if (isset($_GET['displayTheatreDeleteRequest'])) {
            handleGETRequest();
        }
        ?>
        ...
        function executePlainSQL($cmdstr) { //takes a plain (no bound variables) SQL command and executes it
            ...
            if (!$statement) {
                ...
                $success = False;
                // echo '<script>alert("FAILED 208!")</script>';
            }
            ...
            if (!$r) {
                ...
                echo htmlentities($e['message']);
                $success = False;
                // echo '<script>alert("FAILED 217!")</script>';
            }
		...
		See the sample code below for how this function is used */
            ...
            if (!$statement) {
                ...
                echo htmlentities($e['message']);
                $success = False;
                // echo '<script>alert("FAILED 237!")</script>';
            }
            ...
            foreach ($list as $tuple) {
                ...
                if (!$r) {
                    ...
                    echo "<br>";
                    // $success = False;
                    // echo '<script>alert("FAILED 255!")</script>';
        ...
        function handleInsertRequest() {
            ...
            // echo '<script>alert("line348")</script>';
            OCICommit($db_conn);
        }
